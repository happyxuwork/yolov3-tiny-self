...
def convert_annotation(image_id):
    in_file = open(image_id, encoding='utf8')
    ...
    for i, obj in enumerate(root.iter('object')):
        ...
        if cls not in target_objects:
            continue
        cls_id = target_objects.index(cls)
...
def main(images_path, annos_path, tfrecords_name,xml_file_name):
    ...
    for image_id in image_ids:
        ...
        anno_path = os.path.join(annos_path,image_id+".xml")
...
if __name__ == "__main__":
    resize_width = 512
    resize_height = 288
    images_path = "F:/ourtogether/allin/train/Original/"
    annos_path = "F:/ourtogether/allin/train/Annotations/"
    # tfrecords_name = "demo.tfrecords"
    tfrecords_name = "F:/ourtogether/allin/train/train_allin_416_416.tfrecords"
